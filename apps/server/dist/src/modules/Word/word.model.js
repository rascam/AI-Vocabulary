...
function getWordsByUserId(userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.word.findMany({
                        where: {
                            userId: userId
                        }
                    })];
...
exports.getWordsByUserId = getWordsByUserId;
function createWord(wordToCreate) {
    return __awaiter(this, void 0, void 0, function () {
        var createdWord;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.word.create({
                        data: {
