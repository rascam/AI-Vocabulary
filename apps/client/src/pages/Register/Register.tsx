  ...
  return (
    <div className="initDialog flex-col" id="initDialog">
      ...
      <h2 className="text-lg text-left mt-7">Which is your native language?</h2>
        <select id="input-initSrcLang" name="srcLang" value={srcLang} onChange={(e) => setSrcLang(e.target.value)}>
        ...
        <select id="input-initTargetLang" name="targetLang" value={targetLang} onChange={(e) => setTargetLang(e.target.value)}>
        ...
        <select id="input-initLevel" name="level" value={level} onChange={(e) => setLevel(e.target.value)}>
        ...
        <input type="text" className="inputfield initDialogInput mt-2 mb-2" id='input-initName' name="name"
          placeholder="your name (optional)" value={name} onChange={(e) => setName(e.target.value)}/>
       <input type="text" className="inputfield initDialogInput mb-2" id='input-initEmail' name="email"
          placeholder="your email" value={email} onChange={(e) => setEmail(e.target.value)}/>
        <input type="text" className="inputfield initDialogInput mb-10" id='input-initEmail' name="email"
          placeholder="superstrong password" value={password} onChange={(e) => setPassword(e.target.value)}/>
        {errorMessage && <ErrorMessage text={errorMessage} />}
        <button type="submit" className='button' id="button-initUserData">Create account</button>
      </form>
    </div>
  )
}
