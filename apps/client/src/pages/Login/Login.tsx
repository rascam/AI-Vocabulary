  ...
  return (
    <div className="initDialog flex-col items-center" id="initDialog">
      ...
      <h2 className="text-lg text-left mt-6">Did we see us before?</h2>
        <input type="text" required className="inputfield initDialogInput max-w-md mr-2" id='input-initName' name="email"
          placeholder="your email" value={email} onChange={(e) =>  setEmail(e.target.value)}/>
           <input type="password" required className="inputfield initDialogInput max-w-md mr-2" id='input-initPassword' name="password"
