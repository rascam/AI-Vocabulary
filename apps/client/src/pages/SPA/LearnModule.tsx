...
function LearnModule({words, slowSpeech, autoPlay, userScore, userId, setUser, bins, setBins}:
  {words: Word[], slowSpeech: boolean, autoPlay: boolean, userScore: number | undefined, userId: string,
        ...
        <div className={`content ${`card${frontCard?.bin}` || 'card0'}`} id="cardBorder">
          <div className="cardFront"
            ...
            <div className="inner">
              ...
              {learnStack.length > 0 && <div className="yesNo">
                <label onClick={() => {if(autoPlay) setTimeout(playAudio, 1000)}} htmlFor="flipCard" className="buttonFlipCard" aria-hidden="true">
          ...
          <div className="cardBack" id="cardBack"
            ...
            <div className="inner">
              ...
              <div onClick={playAudio} className="playButton mt-3" id="playButtonLearn">
